  ...
  stream.executable private @repro_603 {
    ...
    builtin.module {
      func.func @repro_603(%arg_a: !stream.binding, %arg_b: !stream.binding, %arg_e: !stream.binding, %arg_a_transpose: !stream.binding, %arg_c: !stream.binding, %arg_d: !stream.binding) attributes {translation_info = #translation} {
        ...
        %b = stream.binding.subspan %arg_b[%c0] : !stream.binding -> memref<32x16xf16, strided<[16, 1], offset: ?>>
        ...
        %b_reg = vector.load %b[%3, %8] : memref<32x16xf16, strided<[16, 1], offset: ?>>, vector<4xf16>
        %a = stream.binding.subspan %arg_a[%c0] : !stream.binding -> memref<16x16xf16, strided<[16, 1], offset: ?>>
        %c = stream.binding.subspan %arg_c[%c0] : !stream.binding -> memref<16x32xf32, strided<[32, 1], offset: ?>>
        %e = stream.binding.subspan %arg_e[%c0] : !stream.binding -> memref<32x16xf16, strided<[16, 1], offset: ?>>
        ...
        vector.store %16, %c[%6, %3] : memref<16x32xf32, strided<[32, 1], offset: ?>>, vector<1xf32>
        ...
        vector.store %17, %c[%18, %3] : memref<16x32xf32, strided<[32, 1], offset: ?>>, vector<1xf32>
        ...
        vector.store %19, %c[%20, %3] : memref<16x32xf32, strided<[32, 1], offset: ?>>, vector<1xf32>
        ...
        vector.store %21, %c[%22, %3] : memref<16x32xf32, strided<[32, 1], offset: ?>>, vector<1xf32>
        %e_reg = vector.load %e[%3, %6] : memref<32x16xf16, strided<[16, 1], offset: ?>>, vector<4xf16>
        ...
        %d = stream.binding.subspan %arg_d[%c0] : !stream.binding -> memref<32x16xf16, strided<[16, 1], offset: ?>>
        %28 = arith.addi %1, %6 overflow<nsw, nuw> : index
        %29 = arith.addi %2, %7 overflow<nsw, nuw> : index
        vector.store %26, %d[%28, %29] : memref<32x16xf16, strided<[16, 1], offset: ?>>, vector<1xf16>
        ...
        vector.store %30, %d[%31, %29] : memref<32x16xf16, strided<[16, 1], offset: ?>>, vector<1xf16>
        ...
        vector.store %32, %d[%33, %29] : memref<32x16xf16, strided<[16, 1], offset: ?>>, vector<1xf16>
        ...
        vector.store %34, %d[%35, %29] : memref<32x16xf16, strided<[16, 1], offset: ?>>, vector<1xf16>
        return
      }
    }
  }
  func.func @isolated_benchmark(%arg_a: tensor<16x16xf16>, %arg_b: tensor<32x16xf16>, %arg_e: tensor<32x16xf16>, %arg_a_transpose: tensor<16x16xf16>, %arg_c: tensor<16x32xf32>, %arg_d: tensor<32x16xf16>) -> (tensor<16x16xf16>, tensor<16x32xf32>, tensor<32x16xf16>) {
    %b:3 = flow.dispatch @repro_603::@repro_603(%arg_a, %arg_b, %arg_e, %arg_a_transpose, %arg_c, %arg_d) : (tensor<16x16xf16>, tensor<32x16xf16>, tensor<32x16xf16>, tensor<16x16xf16>, tensor<16x32xf32>, tensor<32x16xf16>) -> (%arg_a_transpose, %arg_c, %arg_d)
    return %b#0, %b#1, %b#2 : tensor<16x16xf16>, tensor<16x32xf32>, tensor<32x16xf16>
  }
}
